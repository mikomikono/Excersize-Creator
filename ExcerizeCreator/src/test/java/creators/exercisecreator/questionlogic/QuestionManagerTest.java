...
public class QuestionManagerTest {
    ...
    public void managerCreatesTOF() {
        ...
        assertNotNull(this.qm.getQuestions().get(0));
    }
    ...
    public void tOFReturnsAnswer() {
        ...
        assertEquals(this.qm.getQuestions().get(0).returnAnswer(), "T");
        assertEquals(this.qm.getQuestions().get(1).returnAnswer(), "F");
    }
    
    @Test
    public void openQuesReturnsAnswer() {
        this.qm.createOQ("Never gonna give", "Never gonna give", "give you up");
        assertNotNull(this.qm.getQuestions().get(0).returnAnswer());
    }
    ...
    public void tOFAnsweringWorks() {
        ...
        assertEquals("T", this.qm.getQuestions().get(0).returnAnswered());
        assertEquals("F", this.qm.getQuestions().get(1).returnAnswered());
        assertNull(this.qm.getQuestions().get(2).returnAnswered());
    }
    ...
    public void openQuesAnsweringWorks() {
        ...
        assertNotNull(this.qm.getQuestions().get(0).returnAnswered());
    }
    ...
    public void tOFReturnsNotes() {
        ...
        assertEquals("How I'm feeling", this.qm.getQuestions().get(0).returnNotes());
    }
    
    @Test
    public void openQuesReturnsNotes() {
        this.qm.createOQ("Don't tell me", "You're too blind", "To see");
        assertEquals("You're too blind", this.qm.getQuestions().get(0).returnNotes());
    }
    ...
    public void essayReturnsNotes() {
        ...
        assertEquals("Never gonna let you down", this.qm.getQuestions().get(0).returnNotes());
    }
    ...
    public void tOFCheckWorks() {
        ...
        assertTrue(this.qm.getQuestions().get(0).returnCorrect());
        assertFalse(this.qm.getQuestions().get(1).returnCorrect());
    }
    ...
    public void essayCheckWorks() {
        ...
        assertFalse(this.qm.getQuestions().get(0).returnCorrect());
    }
    ...
    public void managerReturnsQuestionStrings() {
        ...
        assertEquals(qs, this.qm.getQuestionStrings());
    }
    ...
    public void managerReturnsCorrects() {
        ...
        cs.add(Boolean.FALSE);
        cs.add(Boolean.TRUE);
        assertEquals(cs, this.qm.getCorrects());
        assertEquals(Boolean.TRUE, this.qm.getCorrect("Never gonna make you cry"));
        assertEquals(Boolean.FALSE, this.qm.getCorrect("Never gonna make you cry :("));
    }
    ...
    public void checkingWorks() {
        ...
        this.qm.check();
        assertEquals(Boolean.TRUE, this.qm.getQuestions().get(0).returnCorrect());
        assertEquals(Boolean.TRUE, this.qm.getQuestions().get(1).returnCorrect());
    }
    
    @Test
    public void returningNotesWorks() {
        this.qm.createEssay("Never gonna give", "Give you up", "Never gonna give");
        assertEquals("Give you up", this.qm.getNotes("Never gonna give"));
    }
    
    @Test
    public void returningNotesWorksWithNoNotes() {
        assertEquals("", this.qm.getNotes("Give you up"));
    }
    ...
    public void questionsReturnCorrectTypes() {
        ...
        this.qm.createTOF("Never gonna make you cry", "Never gonna say goodbye", Boolean.FALSE);
        assertEquals(0, this.qm.getQuestions().get(3).returnType());
        assertEquals(1, this.qm.getQuestions().get(2).returnType());
        assertEquals(2, this.qm.getQuestions().get(0).returnType());
        assertEquals(3, this.qm.getQuestions().get(1).returnType());
    }
    ...
    public void questionToStringsCorrect() {
        ...
        assertEquals("question: Never gonna give you up; answer: null; correct answer: true", this.qm.getQuestions().get(0).toString());
        assertEquals("question: Never gonna; answer: null; correct answer: And desert you", this.qm.getQuestions().get(1).toString());
        assertEquals("question: Never gonna make you cry; answer: null", this.qm.getQuestions().get(2).toString());
        assertEquals("question: Never gonna give; answer: null", this.qm.getQuestions().get(3).toString());
    }
    ...
    public void managerReturnsInfo() {
        ...
        info.add(line);
        assertEquals(this.qm.getInfo(), info);
    }
    ...
    public void feedbackWorks() {
        ...
        assertEquals("", this.qm.getQuestions().get(0).returnAnswer());
        assertEquals(Boolean.FALSE, this.qm.getQuestions().get(0).returnCorrect());
        assertEquals("I am enjoying this immensly :)", this.qm.getQuestions().get(0).returnAnswered());
        assertEquals("Thank you for your feedback!", this.qm.getQuestions().get(0).returnNotes());
